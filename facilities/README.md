...
1. Quad, where x<sup><i>y</i></sup>, if x = 4, y = 2 => 16

2. Matrix, where x<sup><i>y</i></sup>, if x = 4, y = 4 => 256

3. Cluster, where x<sup><i>y</i></sup>, if x = 9, y = 4 => 6561

4. Array, where x<sup><i>y</i></sup>, if x = j, y = k => m
